...
import 'atn/lexer_actions.dart';
import 'atn/semantic_context.dart';
...
class Dfa {
  ...
  DfaState getPrecedenceStartStateFor(int precedence) {
    ...
    return (precedence < 0 || precedence >= s0.edges.length)
        ? null
        : s0.edges[precedence];
  }
...
class DfaState {
  ...
  String toString() {
    StringBuffer sb = new StringBuffer()
      ...
      ..write(configs);
    if (isAcceptState) {
      sb..write("=>")..write(predicates != null ? predicates : prediction);
    }
    return sb.toString();
  }
}
...
class DfaSerializer {
  ...
  String _edgeLabelFor(int i) {
    return (i == 0)
        ? "EOF"
        : (tokenNames != null) ? tokenNames[i - 1] : new String.fromCharCode(i);
  }
