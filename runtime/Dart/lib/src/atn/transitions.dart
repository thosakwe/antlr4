...
abstract class Transition {
  ...
  static const List<String> serializationNames = const <String>[
    "INVALID",
    "EPSILON",
    "RANGE",
    "RULE",
...
class SetTransition extends Transition {
  ...
  SetTransition(AtnState target, [IntervalSet set])
      : this.set =
            (set != null) ? set : IntervalSet.ofSingle(Token.INVALID_TYPE),
        super._internal(target);
...
class PredicateTransition extends AbstractPredicateTransition {
  ...
  PredicateTransition(
      AtnState target, this.ruleIndex, this.predIndex, this.isCtxDependent)
      : super(target);
...
class ActionTransition extends Transition {
  ...
  ActionTransition(AtnState target, this.ruleIndex,
