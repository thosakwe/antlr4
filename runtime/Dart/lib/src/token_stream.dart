...
class BufferedTokenStream implements TokenStream {
  ...
  BufferedTokenStream(TokenProvider tokenProvider) {
  ...
  List<Token> getHiddenTokensToRight(int tokenIndex, [int channel = -1]) {
    ...
    int nextOnChannel =
        _nextTokenOnChannel(tokenIndex + 1, Token.DEFAULT_CHANNEL);
    int to;
  ...
  List<Token> getHiddenTokensToLeft(int tokenIndex, [int channel = -1]) {
    ...
    int prevOnChannel =
        _previousTokenOnChannel(tokenIndex - 1, Token.DEFAULT_CHANNEL);
...
/// the lexer.
///
/// The only difference between this source and [BufferedTokenStream] superclass
...
class CommonTokenStream extends BufferedTokenStream {
  ...
  CommonTokenStream(TokenProvider tokenProvider,
