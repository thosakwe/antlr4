...
class IntervalSet {
  ...
  int get maxElement => (isNil) ? Token.INVALID_TYPE : _intervals.last.b;
  ...
  IntervalSet addAll(IntervalSet set) {
    ...
    set._intervals.forEach((i) => add(i.a, i.b));
    return this;
  }
  ...
  void remove(dynamic a) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      // list is sorted and el is before this interval; not here
      if (a < interval.a) break;
      // if whole interval x..x, rm
      if (a == interval.a && a == interval.b) {
